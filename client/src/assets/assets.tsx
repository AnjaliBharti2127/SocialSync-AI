...
// remove the Globe import if nothing else uses it
// import { SiX, SiFacebook, SiInstagram, SiLinkedin } from "@icons-pack/react-simple-icons";
...
export const FacebookIcon = (props: IconProps) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 0 .955.042 1.468.103a8.68 8.68 0 0 1 1.141.195v3.325a8.623 8.623 0 0 0-.653-.036 8.65 8.65 0 0 0-.703-.034c-.735 0-1.309.194-1.813.583-.504.389-.75.972-.75 1.712v1.71h3.744l-.42 2.204-.351 1.463h-2.973v8.283C18.905 22.988 24 17.98 24 11.987A11.98 11.98 0 0 0 12 0 11.98 11.98 0 0 0 0 11.987c0 5.291 3.633 9.735 8.535 10.965z" />
  </svg>
);
...
// import { XIcon, FacebookIcon, InstagramIcon, LinkedinIcon } from "./brand-icons";
// 
export const PLATFORMS: Platform[] = [
  { id: "twitter", name: "Twitter / X", icon: XIcon, description: "Post tweets, threads, and media" },
  { id: "linkedin", name: "LinkedIn", icon: LinkedinIcon, description: "Publish to your profile & company pages" },
  { id: "facebook", name: "Facebook", icon: FacebookIcon, description: "Manage your pages and profile" },
  { id: "instagram", name: "Instagram", icon: InstagramIcon, description: "Share photos, reels and stories" },
];
